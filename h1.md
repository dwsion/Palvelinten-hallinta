...
Tässä kerrottiin, kuinka voi ajaa Saltia lokaalisti ja nähdä heti tulokset. Tärkeimpiä tilafunktioita(states) saltissa ovat (lähde:https://terokarvinen.com/2021/salt-run-command-locally/)
